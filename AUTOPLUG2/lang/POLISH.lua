...
POLISH["UPDATER_SEARCH_UNSAFE_VPK"] =               "Szukanie VPK, zabepieczonych lub niebezpiecznych plików"
...
POLISH["INSTALLP_DESC_QUIETSHOT"] =                 "Wycisza dźwięk migawki podczas wykonywania zrzutu ekranu, zdjęcia, filmu lub zdjęcia panoramicznego. Działa zarówno na Playstation Vita, jak i PlayStation TV."

--ALL
POLISH["INSTALLP_DESC_YAMT"] =                      "Jeszcze inna (ponownie) montowana wtyczka kernela dla PSVita / PSTV (wymaga Enso, kompatybilna TYLKO z oprogramowaniem 3.60 i 3.65)"
...
POLISH["INSTALLP_DESC_FRAMECOUNTER"] =              "Jest to mała wtyczka, która działa jako licznik FPS. Wyświetli licznik FPS w lewym górnym rogu ekranu (SELECT + L Otwórz / Zamknij menu VGi w grze)"
POLISH["INSTALLP_DESC_VGI"] =                       "Prosta wtyczka Taihen, która wyświetla przydatne informacje o grach PS Vita."
POLISH["INSTALLP_DESC_FUCKPSSE"] =                  "Plugin do oszyfrowywania gier PSM"
POLISH["INSTALLP_DESC_PSMPATCH"] =                  "Umożliwia modyfikację gier PSM, a także może być używany do ładowania Homebrew PSM."
POLISH["INSTALLP_DESC_TROPHAX"] =                   "Uniwersalne odblokowywanie trofeów dla PSVITA. (w grze START + SELECT włącz wtyczkę, L + R odblokuj wszystko lub L + START odblokuj określone trofeum, L + UP lub L + DOWN, aby dokonać wyboru, a następnie L + KÓŁKO, aby odblokować)"
POLISH["INSTALLP_DESC_TURBOPAD"] =                  "Ta wtyczka pozwala włączyć RapidFire na dowolnym przycisku. (START + TRÓJKĄT Otwórz menu konfiguracji)"
POLISH["INSTALLP_DESC_RESCALER"] =                  "Ta wtyczka zastępuje oryginalny program do skalowania PSVITA nowym, umożliwiając grom działającym w innej niż macierzysta rozdzielczości uzyskanie ulepszeń graficznych dzięki filtrowaniu za pomocą shaderów. (Przytrzymaj START 2 sek. Blokuje / odblokowuje tryb / zmienia tryb dwuliniowy, Przytrzymaj L 4 sek. Zmienia aktualny tryb przeskalowania, Przytrzymaj R 4 sek. Włącza / wyłącza filtrowanie dwuliniowe)"
POLISH["INSTALLP_DESC_INFINITENET"] =               "Wtyczka taiHEN, która zapobiega wyłączaniu przez gry funkcji sieciowych"
POLISH["INSTALLP_DESC_FREEPSM"] =                   "Umożliwia debugowanie PSM w detalicznym środowisku uruchomieniowym PSM"
POLISH["INSTALLP_DESC_MAKEPSM"] =                   "Modyfikacje aplikacji PSM Developer"
POLISH["INSTALLP_DESC_WDNR"] =                      "Blokada tylnego touchpada dla PSVITA."
POLISH["INSTALLP_DESC_WDNF"] =                      "Wyłącza przedni panel dotykowy"
...
POLISH["INSTALLP_DESC_MODALVOL"] =                  "Ten pakiet zawiera aplikacje do kontrolowania głośności systemu audio na PS vita w czasie rzeczywistym bez zamykania gier. SELECT + PRAWO (Wymagaj VOLUME CONTROL.VPK)"
POLISH["INSTALLP_DESC_TRACKPLUGMOD"] =              "Wtyczka do śledzenia czasu odtwarzania dla PSVITA."
